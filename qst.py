...
2. run a command such as `python ./qst.py 5 3 -n "random_5"` where the parameters of # qubits = 5, # pure states = 3, and file name = "random_5" are changed depending on what experiment you want to perform
